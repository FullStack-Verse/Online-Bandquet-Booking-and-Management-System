				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>Stop worrying about the special occasions. Leave it upon us and you enjoy the occasion.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>Just chill and enjoy. Let all the problems of management be handled by the experts.</p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
